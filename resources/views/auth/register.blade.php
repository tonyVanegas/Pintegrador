                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="celular" required autocomplete="celular"
                                    autofocus>
                            </div>
                        </div>

                        <div class="row mb-3">
                            <label for="telefono_fijo" class="col-md-4 col-form-label text-md-end">Telefono Fijo</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="estado" required autocomplete="estado"
                                    autofocus>
                            </div>
                        </div>
        
                <div class="row mb-3">
                    <label for="type_user" class="col-md-4 col-form-label text-md-end">type user</label>
                    <div class="col-md-6">
